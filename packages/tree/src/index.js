...
var target = {
    hover(props, monitor, component) {
        ...
        var hoverClientX =
            clientOffset.x - hoverBoundingRect.left - component._getCollapsedIndent();
        var leftHover = clientOffset.x - hoverBoundingRect.left;
...
export class Component extends React.Component {
    ...
    _getCode = () => {
        return md5((this.props.dragDropCode || this.props.dragDropType) + window.location.pathname);
    };
    ...
    _getPlaceholderPosition = () => {
        return getPlaceholderPosition(this._getReselectState());
    };
    ...
    _getPlaceholder = (level = 0) => {
        return (
            <div
                ...
                style={{
                    marginLeft: `${(level - 1) * this.props.indentSize +
                        this._getCollapsedIndent()}px`,
                }}
            />
        );
    };
    ...
    render() {
        var { connectDropTarget, wrapperStyle, showBottomMargin } = this.props;
